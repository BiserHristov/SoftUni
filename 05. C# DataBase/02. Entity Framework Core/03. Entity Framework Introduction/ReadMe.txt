...
4. In csprojfile directory enter in command prompt and enter: 
	...
	4.2  ->    dotnet ef dbcontext scaffold "Server=.;Integrated Security=true;Database=Git" Microsoft.EntityFrameworkCore.SqlServer -o Models -f -d
...
4.//Code First:
       dotnet ef migrations add InitialCreate -o Data/Migrations 
					(-o oznachava migraciite da budat v papka Migrations, koiato se namira v papka Data)
